...
import checkApplicationCriteria from '@salesforce/apex/ApplicationHelper.checkApplicationCriteria';
...
export default class ApplicationProgressIndicatorMain extends LightningElement {
	...
	async handleSubmit() {
		try {
			this.isLoading = true;
			console.log('MB, handleSubmit updating app from ApplicationProgressIndicatorMain');
			const app = {
				Id: this.recordId,
				Status__c: "In Progress"
			};

			let submitMessage = await checkApplicationCriteria({ app });
			...
			this.toast("Success", "Application Updated", "success");
	...
	async handleSubmitMain() {
		try {
			this.isLoading = true;
			console.log('MB, handleSubmitMain updating app from ApplicationProgressIndicatorMain');
			const app = {
				Id: this.recordId,
				Status__c: "Submitted"
			};
