...
import { OMNIDEF } from './dFDFWFileUploadEnglish_def.js';
import tmpl from './dFDFWFileUploadEnglish.html';
import tmpl_nds from './dFDFWFileUploadEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class dFDFWFileUploadEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
