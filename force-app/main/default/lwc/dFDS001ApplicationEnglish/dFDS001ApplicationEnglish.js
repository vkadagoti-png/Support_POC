...
import { OMNIDEF } from './dFDS001ApplicationEnglish_def.js';
import tmpl from './dFDS001ApplicationEnglish.html';
import tmpl_nds from './dFDS001ApplicationEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class dFDS001ApplicationEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
