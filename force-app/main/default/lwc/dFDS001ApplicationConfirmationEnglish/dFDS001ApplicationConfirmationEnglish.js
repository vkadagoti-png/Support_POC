...
import { OMNIDEF } from './dFDS001ApplicationConfirmationEnglish_def.js';
import tmpl from './dFDS001ApplicationConfirmationEnglish.html';
import tmpl_nds from './dFDS001ApplicationConfirmationEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class dFDS001ApplicationConfirmationEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
